...
// 1. useSearchParams- Allows you to access the parameters of the current URL.
//    For example, the search params for this URL /dashboard/invoices?page=1&query=pending would look like
//    this:{page: '1', query: 'pending'}.
// 2. usePathname - Lets you read the current URL's pathname.
